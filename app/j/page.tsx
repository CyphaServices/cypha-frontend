...
type HostEventPayload = Record<string, unknown>; // widen later as you define events

const API_BASE = process.env.NEXT_PUBLIC_API_BASE || ''; // e.g. https://api.cyphaent.com
...
export default function JoinPage() {
  ...
  useEffect(() => {
    if (!API_BASE) return; // avoid connecting until env is set
